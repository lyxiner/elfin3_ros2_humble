...
# 1.2 把普通用户加进去
sudo usermod -aG ethercat xx   # 改成个人用户名
...
~/xx_ws/install/elfin_ros_control/lib
~/xx_ws/~/xx_ws/~/xx_ws/~/xx_ws/install/elfin_ethercat_driver/lib
~/xx_ws/~/xx_ws/~/xx_ws/install/elfin_basic_api/lib
~/xx_ws/~/xx_ws/install/soem_ros2/lib
~/xx_ws/install/elfin_robot_msgs/lib
EOF
